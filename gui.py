...
class App(QMainWindow):
    def __init__(self):
        ...
        self.button_search.setStyleSheet('background-color: #00C6CC; color: #ffffff; font-size: 16px; border-radius: 5px; text-aligh: center')
        self.button_search.move(47, 62)
        self.button_search.resize(175, 20)

        self.button_clear.setStyleSheet('background-color: #D3FF00; color: #000000; font-size: 16px; border-radius: 5px; text-aligh: center')
        ...
        self.output_origem.setReadOnly(True)
        ...
        self.output_platinum.setReadOnly(True)
        ...
        self.output_limit_ori.setReadOnly(True)
        ...
        self.output_limit_plat.setReadOnly(True)
        ...
        self.output_dif.setReadOnly(True)
